...
function Youtube() {
  setTimeout(function() {
    window.open('https://www.youtube.com/@idleretard', 'ultimate')},
  100);
}
function Facebook() {
  setTimeout(function() {
    window.open('https://sourceb.in/bozwqX7G2N', 'ultimate')},
  100);
}
function Discord() {
  setTimeout(function() {
    window.open('https://discord.gg/liddellviet', 'ultimate')},
  100);
}
function Telegram() {
  setTimeout(function() {
